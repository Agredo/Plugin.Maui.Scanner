...
-->
![nuget.png](https://raw.githubusercontent.com/jfversluis/Plugin.Maui.Scanner/main/nuget.png)
# Plugin.Maui.Scanner

`Plugin.Maui.Scanner` provides the ability to do this amazing thing in your .NET MAUI application.

## Install Plugin

[![NuGet](https://img.shields.io/nuget/v/Plugin.Maui.Scanner.svg?label=NuGet)](https://www.nuget.org/packages/Plugin.Maui.Scanner/)

Available on [NuGet](http://www.nuget.org/packages/Plugin.Maui.Scanner).

Install with the dotnet CLI: `dotnet add package Plugin.Maui.Scanner`, or through the NuGet Package Manager in Visual Studio.
...
`Plugin.Maui.Scanner` provides the `Feature` class that has a single property `Property` that you can get or set.
